"""
Django settings for bwsmalut project.
...
SECRET_KEY = 'django-insecure-+bgnnw*-yk@2y6)v70#t4@gv!k4yy^gwnp74&w@af57nzx98wi'
...
WSGI_APPLICATION = 'bwsmalut.wsgi.application'
